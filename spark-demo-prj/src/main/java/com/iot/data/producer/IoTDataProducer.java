...
import com.iot.data.producer.util.PropertyFileReader;
...
public class IoTDataProducer {
	...
	public static void main(String[] args) throws Exception {
		...
		properties.put("serializer.class", "com.iot.data.producer.util.IoTDataEncoder");
		//generate event
